...
function HomeworkSection() {
  return (
    <div className="p-4 mb-6 border border-red-500 bg-red-100 rounded-lg">
      ...
      <p className="mt-2 text-gray-700">Why Modifying Resume and LinkedIn is Important?</p>
...
function RequestDemo({ userId, month }) {
  ...
  useEffect(() => {
      ...
      const topic = "Non_tech"; // Set topic as per new API requirement
